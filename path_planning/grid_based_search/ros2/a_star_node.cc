...
int main(int argc, char* argv[]) {
  ...
  auto node =
      std::make_shared<path_planning::grid_based_search::GridBasedSearch<Grid>>(
          "a_star_node",
          path_planning::grid_based_search::a_star::GetSampleResults,
          GridToMsgCallback);
  rclcpp::spin(node);
  rclcpp::shutdown();
  return 0;
